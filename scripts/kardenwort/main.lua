...
local HELP_SCHEMA = {
    ...
    { category = "Search Window", actions = {
        { desc = "Toggle Search HUD", cmd = "kardenwort/toggle-drum-search" },
        { desc = "Move Result Up/Down", cmd = {"search%-up%-", "search%-down%-", "search%-wheel%-up", "search%-wheel%-down"} },
        { desc = "Cursor Left/Right", cmd = {"search%-left", "search%-right"} },
        { desc = "Select Left/Right", cmd = {"search%-left%-shift%-", "search%-right%-shift%-"} },
        { desc = "Jump Word Left/Right", cmd = {"search%-left%-ctrl%-", "search%-right%-ctrl%-"} },
        { desc = "Jump+Select Left/Right", cmd = {"search%-left%-ctrl%-shift%-", "search%-right%-ctrl%-shift%-"} },
        { desc = "Backspace / Delete", cmd = {"search%-bs%-", "search%-del%-"} },
        { desc = "Paste Clipboard", cmd = "search%-paste%-" },
        { desc = "Select All", cmd = "search%-select%-all%-" },
        { desc = "Delete Prev Word", cmd = "search%-delete%-word%-" },
        { desc = "Seek To Selected", cmd = "search%-seek%-selected%-" },
        { desc = "Close Search", cmd = "search%-close%-" },
    }},
