...
local kutils = require 'kardenwort.utils'
...
local is_valid_mpv_key = kutils.is_valid_mpv_key
...
local calculate_ass_alpha = kutils.calculate_ass_alpha
local utf8_to_table = kutils.utf8_to_table
local utf8_to_lower = kutils.utf8_to_lower
...
local is_word_char = kutils.is_word_char
...
local logical_cmp = kutils.logical_cmp
local build_word_list_internal = kutils.build_word_list_internal
...
local find_fuzzy_indices = kutils.find_fuzzy_indices
local calculate_match_score = kutils.calculate_match_score
