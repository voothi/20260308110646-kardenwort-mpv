524110021, 20260524104812, 20260524104807, 20260523163903, 20260523163031, 20260523162613, 20260523161751, 20260523161551, 20260523155603, 20260523155311, 20260523154056, 20260523152559, 20260523152302, 20260523152153, 20260523145653, 20260523142747, 20260523142635, 20260523142318, 20260523141804, 20260523140909, 20260523140822, 20260523135830, 20260523135806, 20260523134531, 20260523132937, 20260523131958, 20260523131847, 20260523130706, 20260523121508, 20260523121327, 20260523120925, 20260523114856, 20260523114643, 20260523113031, 20260523111552, 20260523111520, 20260523110550, 20260523104133, 20260523103820, 20260523101842, 20260523101520, 20260523100931, 20260523100757, 20260523100634, 20260523100026, 20260523095734, 20260523000700, 20260522235327, 20260522231244, 20260522230925, 20260522223029, 20260522214835, 20260522213623, 20260522213446, 20260522210704, 20260522205832, 20260522205612, 20260522202444, 20260522201236, 20260522180034, 20260522175906, 20260522175325, 20260522175106, 20260522170712, 20260522170620, 20260522163949, 20260522163656, 20260522163152, 20260522162418, 20260522161304, 20260522151710, 20260522151646

## Highlights

### 🖼️ **Unified OSD Frame Rendering**
- **Solid Background Box for Notices**: Implemented premium backing card rendering for transient OSD notifications (Replay, Autopause, Shift+q, Shift+a/d) in Drum Window (DW) mode, matching the visual aesthetic of native `background-box` styling.
- **Seek/Scroll OSD Frames**: Extended solid background box rendering to relative seek/scroll notices (+2s, -2s, +4s, -4s) in DW mode, providing consistent visual feedback across all OSD messages.
- **Unified Renderer Path**: Consolidated `show_osd()` and `show_seek_osd()` to use a single compact ASS card renderer across all modes (DW, DM, SRT), eliminating visual inconsistencies between different render paths.

### 🎨 **Tooltip Rendering Unification**
- **Mode-Aware Tooltip Configuration**: Introduced per-mode tooltip background alpha controls (`tooltip_dw_bg_alpha`, `tooltip_dm_bg_alpha`, `tooltip_srt_bg_alpha`) to precisely control tooltip card transparency in each rendering context.
- **Shared Renderer Contract**: Unified tooltip style ownership and rendering across DW/DM/SRT modes with a single `format_tooltip_card()` function, eliminating evolutionary asymmetry between modes.
- **DM Dark-Frame Resolution**: Resolved persistent dark tooltip window issues in Drum Mode by implementing DM-specific transparent card alpha while preserving main subtitle frames.
- **Symmetric Padding**: Applied `tooltip_top_pad_extra` symmetrically to both top and bottom tooltip borders, ensuring consistent visual spacing.

### 🖱️ **Enhanced Mouse Selection & Auto-Scroll**
- **DM Edge Auto-Scroll**: Extended drag-edge auto-scroll functionality to Drum Mode (DM), enabling selection while scrolling back and forth by dragging to top/bottom borders.
- **Overflow-Aware Edge Triggers**: Fixed edge-scroll geometry for low-resolution videos with long wrapped subtitles, ensuring scroll triggers remain reachable even when DW content overflows the 1080p canvas.
- **Spontaneous Scroll Prevention**: Hardened auto-scroll logic to prevent spontaneous downward/escape scrolling when dragging on the last visible line, using hit-zone bounds and directional intent detection.
- **Reversible Scroll Direction**: Implemented reversible edge-scroll direction during a single drag operation, allowing seamless bidirectional scrolling without releasing the mouse.

### 📌 **RMB Tooltip Pin Restoration**
- **Carry-Through Behavior**: Restored RMB hold-drag tooltip behavior, allowing tooltip pin to remain active when carrying from gaps/aisles onto subtitles.
- **Direct Mouse Handler Registration**: Registered `cmd_dw_tooltip_pin` as a direct mouse handler to receive raw `down`/`up`/`move` events, bypassing selection routing conflicts.

### 🧪 **Milestone: 887 Passed Tests**
- **New Regression Coverage**:
  - `tests/acceptance/test_20260522163656_tag_walk_regressions.py`: Extended with tooltip styling, OSD frame rendering, RMB tooltip pin, and auto-scroll behavior tests.
  - `tests/acceptance/test_20260522162418_tooltip_window_degradation.py`: Added mode-by-mode regression checks for DW/DM/SRT tooltip contract.
  - `tests/unit/test_dw_pure_logic.py`: Added focused unit coverage for DW/DM auto-scroll block zone selection.

### 📋 **Specification Updates**
- **DW Mouse Selection Engine**: Updated `openspec/specs/dw-mouse-selection-engine/spec.md` with reachable DW edge-scroll behavior for overflowing wrapped subtitles.
- **Drum Window Tooltip**: Updated `openspec/specs/drum-window-tooltip/spec.md` with symmetric `tooltip_top_pad_extra` contract and RMB carry-through behavior from gaps/aisles.
...
**Date**: 2026-05-21
**Version**: v1.82.26
**Implementation ZIDs**: 20260521113729, 20260521113443, 20260521113242, 20260521112853, 20260521112244, 20260521105908, 20260521104408, 20260521092225, 20260520213832
...
- **Parity Verification**: Integrated acceptance scenarios to verify that database-matched phrases respect the configured `anki_highlight_bold` state (rendering with bold `{\b1}` tags when set to `yes` and regular `{\b0}` weight when set to `no`) while manual interactive selections strictly enforce regular font weight (`{\b0}`).
...
- **Direct OSD Block Validation**: Instrumented direct verification of OSD feedback using the property `user-data/kardenwort/last_osd` to ensure that no "X" (blocked command) OSD alert is triggered during any of these operations when subtitles are visually turned OFF inside the Drum Window.
...
### 📋 **Formal OpenSpec Requirements & Specification Integration**
- **Requirements Mapping**: Formally specified the behavioral requirements and verification scenarios for Drum Window Visibility Resilience, Database Phrase Bold Highlighting Parity, and Cache-Backed Translation Context Fallbacks in the official `openspec/specs/` directory.
- **Experimental Workflow Archival**: Created and archived the OpenSpec change proposal `20260521112715-visibility-resilience-bold-parity`, ensuring 100% traceability of requirements to commits.

### 🧪 **Milestone: 800 Passed Tests**
- **Robust Acceptance Suite**: Added structural unit tests under `tests/acceptance/test_20260521091631_manual_phrase_bold_parity.py` and a fallback integration test `test_20260521104712_dw_copy_context_mode_b_fallback` in `tests/acceptance/test_20260427003254_copy_sub_fallback.py` to assert the integrity of bold phrase rendering and fallback context copies.
- **Comprehensive Regression Protection**: Added `tests/acceptance/test_20260521111616_visibility_resilience.py` containing high-fidelity acceptance tests to rigorously assert that interactive DW keybindings properly bypass master subtitle visibility blocks. All **800 tests** pass successfully.
...
**Date**: 2026-05-15
**Version**: v1.82.2
**Implementation ZIDs**: 20260515184543, 20260515184510, 20260515184320, 20260515184245, 20260515184138, 20260515184124, 20260515183952, 20260515183933, 20260515183811, 20260515183730, 20260515183634, 20260515183516, 20260515183148, 20260515182753, 20260515182420, 20260515181818, 20260515181401, 20260515180740, 20260515180552, 20260515180421, 20260515180217, 20260515175915, 20260515175814, 20260515175431, 20260515175009, 20260515174613, 20260515174229
