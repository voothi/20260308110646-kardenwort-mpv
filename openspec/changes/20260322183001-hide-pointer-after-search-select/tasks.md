...
## Implementation
- [x] **Keyboard Selection**: Update `ENTER` binding in `manage_search_bindings` to set `FSM.DW_CURSOR_WORD = -1`. <!-- id: 0 -->
- [x] **Mouse Selection**: Update `search_mouse_click` logic to set `FSM.DW_CURSOR_WORD = -1`. <!-- id: 1 -->
