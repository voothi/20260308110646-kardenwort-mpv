...
- [x] 4.1 Verify that Right-Click (pin) followed by Left-Click instantly hides the pinned hint.
- [x] 4.2 Verify that clicking and dragging the Left-Mouse-Button across multiple lines keeps all tooltips suppressed until release.
- [x] 4.3 Verify that after releasing a drag on a specific line, no tooltip appears for that line until the mouse focus moves to a different line.
- [x] 4.4 Verify that holding the Middle Mouse Button (Wheel) suppresses all tooltips regardless of mouse movement.
