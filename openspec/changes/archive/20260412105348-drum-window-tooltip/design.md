...
- **Hold to Peek (Scanned Hover):** While `MBTN_RIGHT` is held, the system enables temporary hover updates. Releasing the button preserves the PIN on the last scanned line, adhering to normal "Click" logic.
