...
- [ ] 2.3 Gather the context lines from `Tracks.sec.subs`: Loop from `center_idx - Options.dw_tooltip_context_lines` to `center_idx + Options.dw_tooltip_context_lines`. Join their texts using `"\\N"`.
