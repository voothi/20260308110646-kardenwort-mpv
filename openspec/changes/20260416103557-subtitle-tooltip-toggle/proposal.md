...
- **Implement adaptive tracking for navigation**: In Book Mode, the toggled tooltip ('e') should automatically update to follow the currently active subtitle as the user seeks via navigation keys (`a`, `d`) or playback.
