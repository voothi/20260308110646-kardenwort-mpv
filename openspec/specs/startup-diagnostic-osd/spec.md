# startup-diagnostic-osd Specification

## Purpose
Provides immediate, high-fidelity visual feedback upon session restoration, confirming the successfully loaded media and identifying available subtitle tracks. This ensures the user is oriented within their environment without needing to query the player's state manually.
