...
## Purpose
Provide a robust global subtitle search interface that allows users to locate specific terms across the entire media duration and jump to the corresponding timestamps.
