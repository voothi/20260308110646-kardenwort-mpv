# Specification: Cache Hardening

## Requirement: Synchronized Cache Invalidation
All rendering layers (SRT, Drum, Tooltip) SHALL respond to a centralized invalidation signal to prevent stale UI states during configuration or mode changes.
