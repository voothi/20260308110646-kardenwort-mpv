# dw-transition-selection-policy Specification

## Purpose
TBD - created by archiving change 20260518234819-dw-transition-selection-policy-matrix. Update Purpose after archive.
## Requirements
