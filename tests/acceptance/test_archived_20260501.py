...
class TestDrumWindowRegressions:
    ...
    def test_dw_esc_staged_reset_preserves_window(self, mpv):
        ...
        ipc.command(['script-message-to', 'lls_core', 'lls-test-set-cursor', '1', '0'])
    ...
    def test_dw_pointer_sync_preservation(self, mpv):
        ...
        ipc.command(['script-message-to', 'lls_core', 'lls-test-set-cursor', '2', '2'])
        time.sleep(0.2)
...
class TestExportFidelity:
    ...
    def test_precision_tokenization(self, mpv):
        ...
        ipc.command(['script-message-to', 'lls_core', 'lls-test-ctrl-toggle-word', '1', '2'])
        time.sleep(0.2)
