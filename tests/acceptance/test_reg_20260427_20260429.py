...
class TestAprilArchivedRegressions:
    ...
    def test_reg_20260427003254_copy_sub_fallback(self, mpv_fragment1):
    ...
    def test_reg_20260427011411_dw_active_line_sync(self, mpv_fragment1):
    ...
    def test_reg_20260427014503_sub_visibility(self, mpv_fragment1):
    ...
    def test_reg_20260427161414_sub_merging(self, mpv_merge_test):
    ...
    def test_reg_20260427200421_drum_spacing(self, mpv_fragment1):
    ...
    def test_reg_20260427233207_drum_spacing_options(self, mpv_fragment1):
    ...
    def test_reg_20260429195210_keyboard_precision_nav(self, mpv_fragment1):
    ...
    def test_reg_20260429151207_pink_metadata_skip(self, mpv):
        """Verify Pink selection skips metadata tags in export (20260429151207)."""
        # Requires a fixture with [METADATA] tags.
        pass

    def test_reg_20260427233207_binary_search_precision(self, mpv_fragment1):
    ...
    def test_reg_20260429133044_empty_sub_height(self, mpv_fragment1):
    ...
    def test_reg_20260427161414_dw_copy_verbatim(self, mpv_fragment1):
    ...
    def test_reg_20260429142144_terminal_period_restoration(self, mpv_fragment1):
    ...
    def test_reg_20260428192102_ellipsis_spacing(self, mpv_fragment1):
