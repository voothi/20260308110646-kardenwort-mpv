...
class TestImmersionRegressions:
    ...
    def test_adaptive_replay_autopause_on(self, mpv_fragment1):
    ...
    def test_subtitle_looping_autopause_off(self, mpv_fragment1):
    ...
    def test_drum_mode_navigation_sync(self, mpv_dual):
...
class TestInputClipboardRegressions:
    ...
    def test_selection_priority_context_copy(self, mpv):
    ...
    def test_layout_agnostic_hotkeys(self, mpv):
...
class TestUiSystemRegressions:
    ...
    def test_tooltip_hit_zone_no_ghosts(self, mpv):
    ...
    def test_session_resume_logic(self, mpv):
    ...
    def test_smart_logging_suppression(self, mpv):
...
class TestSystemHardeningRegressions:
    ...
    def test_srt_parser_hardening(self, mpv):
